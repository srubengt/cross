...
<section class="content-header hidden-xs">
    <h1>
        Payments
        <small>Listado</small>
        <small><strong><?= $months[$month]?>  - <strong><?= $year ?></strong></small>
    </h1>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3>Payments <?= $months[$month] ?> <?= $year ?><h3>
                ...
                <div class="box-body">
                    ...
                    <table id="table_payments" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th scope="col"><?= $this->Paginator->sort('type', 'Tipo Pago') ?></th>
                            <th scope="col"><?= $this->Paginator->sort('amount', 'Cantidad') ?></th>
                        ...
                        <?php foreach ($payments as $payment): ?>
                            <tr>
                                ...
                                <td><?= $payment->rate_id? $rates[$payment->rate_id]: '' ?></td>
                                <td>

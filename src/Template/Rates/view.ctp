...
<div class="rates view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $this->Number->format($rate->price) ?></td>
        </tr>
        <tr>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th scope="col"><?= __('Month Payment') ?></th>
                <th scope="col"><?= __('Year Payment') ?></th>
                <th scope="col"><?= __('Amount') ?></th>
                <th scope="col"><?= __('Discount') ?></th>
                <th scope="col"><?= __('Igic') ?></th>
            ...
            <tr>
                ...
                <td><?= h($payments->month_payment) ?></td>
                <td><?= h($payments->year_payment) ?></td>
                <td><?= h($payments->amount) ?></td>
                <td><?= h($payments->discount) ?></td>
                <td><?= h($payments->igic) ?></td>

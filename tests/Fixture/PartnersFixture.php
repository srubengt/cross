...
class PartnersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'active' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => 'True=Tarifa de socio activa, false=> tarifa de socio no activa', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'rate' => 1,
            'price' => 1.5,
            'created' => '2018-01-30 13:24:25',
            'modified' => '2018-01-30 13:24:25',
            'active' => 1
        ],
    ];
}
